    ...
    <div class="row justify-content-center mb-5">
        <div class="col-md-9 text-center">
          ...
          For the trips we have designed all through field operator research,
            ...
            <a href="https://wa.me/6281358953453?text=Hello Java Volcano Tour Operator. i want to book this package :) <?php echo base_url()."packages/".$package['url'] ?>" class="btn btn-success mt-4 btn-bold"><span class="fa fa-whatsapp"></span> Whatsapp now</a>
